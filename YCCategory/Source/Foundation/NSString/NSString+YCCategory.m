...
#import "NSString+YCCategory.h"

@implementation NSString(YCCategory)
...
- (CGSize)yc_sizeWithFont:(UIFont *)font {
    return [self sizeWithAttributes:@{NSFontAttributeName: font}];
}

+ (BOOL)yc_isMobileNumber:(NSString *)mobileNum {
...
+ (BOOL)yc_isInviteCode:(NSString *)inviteCode {
    NSString *pattern = @"^\\d{6}$";
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", pattern];
    return [predicate evaluateWithObject:inviteCode];
}
